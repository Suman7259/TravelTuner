...
const HomePage = ({
  ...
  const features = [
    {
      icon: (
        <FeatureIcon path="M9.75 3.104l-2.29 2.29h-3.06c-1.14 0-2.08.94-2.08 2.08v1.82h1.82L10.5 15.5V18a1.5 1.5 0 003 0v-2.5l6.19-6.19h1.82v-1.82c0-1.14-.94-2.08-2.08-2.08h-3.06l-2.29-2.29A1.5 1.5 0 009.75 3.104zM4.5 9.75v-1.82a.26.26 0 01.26-.26h3.06l2.29 2.29H4.5z" />
      ),
    ...
    {
      icon: (
        <FeatureIcon path="M10.5 6h9.75M10.5 12h9.75M10.5 18h9.75M3.75 6h.008v.008H3.75V6zm.375 0a.375.375 0 11-.75 0 .375.375 0 01.75 0zM3.75 12h.008v.008H3.75V12zm.375 0a.375.375 0 11-.75 0 .375.375 0 01.75 0zM3.75 18h.008v.008H3.75V18zm.375 0a.375.375 0 11-.75 0 .375.375 0 01.75 0z" />
      ),
    ...
    {
      icon: (
        <FeatureIcon path="M12 3v2.25m6.364.386l-1.591 1.591M21 12h-2.25m-.386 6.364l-1.591-1.591M12 18.75V21m-6.364-.386l1.591-1.591M3 12h2.25m.386-6.364L6.236 7.236" />
      ),
    ...
    {
      icon: (
        <FeatureIcon path="M2.25 18.75a60.07 60.07 0 0115.797 2.101c.727.198 1.453-.342 1.453-1.096V18.75M3.75 4.5v.75A.75.75 0 013 6H2.25m0 0v-.75A.75.75 0 013 4.5H3.75m0 0v.75A.75.75 0 013 6H2.25m9-1.5V5.25A.75.75 0 0012 6h-.75m0 0V5.25A.75.75 0 0010.5 4.5h.75M15 11.25a3 3 0 11-6 0 3 3 0 016 0z" />
      ),
  ...
  return (
    <div className="relative min-h-screen bg-gray-900 text-white overflow-x-hidden">
      ...
      <div
        ...
        style={{
          backgroundImage: `url('https://i.pinimg.com/736x/c3/d8/3a/c3d83a9fc71ccc18b1a23e3921aa6b67.jpg')`,
        }}
      >
      ...
      <div className="relative z-10">
        ...
        <section className="pt-32 pb-20 text-center">
          <div className="container max-w-5xl mx-auto px-6">
            ...
            <p className="text-lg md:text-xl mb-10 text-blue-100/90 max-w-3xl mx-auto">
              Discover hyper-personalized travel experiences. Let our AI craft
              your unforgettable itinerary in seconds.
            </p>
          </div>
        </section>
        ...
        {generatedItinerary && (
          <section id="generated-itinerary" className="pb-20">
            <div className="container mx-auto px-6">
              <div className="max-w-5xl mx-auto bg-white/10 backdrop-blur-xl rounded-3xl p-8 shadow-2xl border border-white/20">
                ...
                <div className="flex flex-wrap gap-4 mt-6 justify-center">
                  ...
                  <button
                    ...
                    className="bg-gradient-to-r from-green-400 to-emerald-500 text-white px-6 py-3 rounded-full font-semibold transform hover:-translate-y-1 hover:shadow-xl transition-all duration-300"
                  >
                    💾 Download as Text
                  </button>
                  <button
                    onClick={() => window.print()}
                    className="bg-gradient-to-r from-blue-400 to-cyan-500 text-white px-6 py-3 rounded-full font-semibold transform hover:-translate-y-1 hover:shadow-xl transition-all duration-300"
                  >
                    🖨️ Print
                  </button>
                </div>
              ...
              <div className="bg-gradient-to-r from-teal-600/20 via-blue-700/20 to-indigo-700/20 rounded-2xl p-6 mb-6 hover:shadow-xl transition-shadow duration-300">
                <div className="flex flex-col md:flex-row md:items-center md:justify-between">
                  <div className="flex items-center mb-4 md:mb-0">
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
                      className="h-12 w-12 text-teal-400 mr-4"
                      fill="none"
                      viewBox="0 0 24 24"
                      stroke="currentColor"
                    >
                      <path
                        ...
                        strokeLinejoin="round"
                        strokeWidth={2}
                        d="M3 7l9 6 9-6-9-6-9 6zM12 13v8m0 0h6m-6 0H6"
                      />
                    </svg>
                    <div>
                      <h3 className="text-xl font-bold text-white">Flights</h3>
                      <p className="text-sm text-blue-100/80">
                        Find and book your perfect flight instantly.
                      </p>
                    </div>
                  </div>
                  <button
              ...
              <div className="bg-gradient-to-r from-pink-600/20 via-red-700/20 to-purple-700/20 rounded-2xl p-6 mb-6 hover:shadow-xl transition-shadow duration-300">
                <div className="flex flex-col md:flex-row md:items-center md:justify-between">
                  <div className="flex items-center mb-4 md:mb-0">
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
                      className="h-12 w-12 text-pink-400 mr-4"
                      fill="none"
                      viewBox="0 0 24 24"
                      stroke="currentColor"
                    >
                      <path
                        ...
                        strokeLinejoin="round"
                        strokeWidth={2}
                        d="M3 12l2-2m0 0l7-7 7 7M13 5v6h6M5 10v10h14V10H5z"
                      />
                    </svg>
                    <div>
                      <h3 className="text-xl font-bold text-white">Hotels</h3>
                      <p className="text-sm text-blue-100/80">
                        Search and book hotels that fit your travel plans.
                      </p>
                    </div>
                  </div>
                  <button
              ...
              <div className="bg-gradient-to-r from-green-600/20 via-lime-700/20 to-emerald-700/20 rounded-2xl p-6 mb-6 hover:shadow-xl transition-shadow duration-300">
                <div className="flex flex-col md:flex-row md:items-center md:justify-between">
                  <div className="flex items-center mb-4 md:mb-0">
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
                      className="h-12 w-12 text-green-400 mr-4"
                      fill="none"
                      viewBox="0 0 24 24"
                      stroke="currentColor"
                    >
                    ...
                    <div>
                      ...
                      <p className="text-sm text-blue-100/80">
                        Book train tickets across India quickly and safely.
                      </p>
                    </div>
                  </div>
                  <button
                  ...
                  <div className="flex items-center mb-4 md:mb-0">
                    ...
                    >
                      <path
                        ...
                        strokeLinejoin="round"
                        strokeWidth={2}
                        d="M5 13l4 4L19 7M5 7h14v14H5V7z"
                      />
                    </svg>
                    <div>
                      <h3 className="text-xl font-bold text-white">Rentals</h3>
                      <p className="text-sm text-blue-100/80">
                        Book car rentals for your trip easily.
                      </p>
                    </div>
                  </div>
                  <button
        ...
        <section className="py-16 bg-gray-900/30">
          <div className="container max-w-5xl mx-auto px-6">
            <h2 className="text-4xl font-bold text-center mb-12 text-white">
              Why Choose TravelTuner?
            </h2>
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
              {features.map((feature) => (
                <div
                  key={feature.title}
                  className="bg-white/5 backdrop-blur-md rounded-2xl p-6 border border-white/10 hover:border-teal-400/50 hover:-translate-y-2 transition-all duration-300 group"
                >
                  ...
                  <p className="text-sm text-blue-100/80 leading-relaxed text-center">
                    {feature.desc}
                  </p>
                </div>
              ))}
